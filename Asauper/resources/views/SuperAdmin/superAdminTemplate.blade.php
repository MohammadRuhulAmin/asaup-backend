           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a class="active-menu"  href="{{route('superAdmin.index')}}"><i class="fa fa-dashboard fa-3x"></i> Dashboard</a>
                    </li>
                     <li>
                        <a  href="{{route('superAdmin.employeePage')}}"><i class="fa fa-desktop fa-3x"></i> Employees </a>
                    </li>
                    <li>
                        <a  href="{{route('superAdmin.registerPage')}}"><i class="fa fa-qrcode fa-3x"></i> User & Information</a>
                    </li>
						   <li  >
                        <a   href="{{route('superAdmin.settings')}}"><i class="fa fa-bar-chart-o fa-3x"></i> Settings</a>
                    </li>
                      <li  >
